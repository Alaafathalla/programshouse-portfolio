    ...
    <section className="relative isolate overflow-hidden px-6 py-24">
      ...
      <div className="relative mx-auto max-w-[1320px]">
        ...
        >
          ...
          {/* Match this color with the visible background */}
          ...
          <h2 className="relative z-20 mx-auto max-w-[700px] text-[30px] font-bold leading-[1.4] tracking-[-0.04em] text-white md:text-[44px]">
            ...
            <br />
            driven <span className="text-primary">expertise</span>
          </h2>
          ...
          <motion.a
            ...
            whileHover={{ y: -4 }}
            whileTap={{ scale: 0.98 }}
            className="absolute bottom-0 left-1/2 z-30 flex h-[45px] min-w-[270px] -translate-x-1/2 translate-y-1/2 items-center justify-center rounded-[12px] bg-primary px-8 text-sm font-semibold text-white  transition-all duration-300 "
          >
            Contact Us
          </motion.a>
        </motion.div>
